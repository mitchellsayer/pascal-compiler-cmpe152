...
{
public:
    StructuredDataGenerator(CodeGenerator *parent, Compiler *compiler) : CodeGenerator(parent, compiler) {}
...
private:
     ...
     */
    void emitAllocateArrayElements(SymtabEntry *targetId, Typespec *elmtType, int dimensionIndex, int dimensionCount);
};
