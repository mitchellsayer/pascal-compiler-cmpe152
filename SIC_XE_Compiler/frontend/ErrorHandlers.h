...
public:
    SemanticErrorHandler() : count(0), first(true) {
        SEMANTIC_ERROR_MESSAGES[UNDECLARED_IDENTIFIER] ="Undeclared identifier";
        SEMANTIC_ERROR_MESSAGES[REDECLARED_IDENTIFIER] ="Redeclared identifier";
        SEMANTIC_ERROR_MESSAGES[INVALID_CONSTANT] ="Invalid constant";
        SEMANTIC_ERROR_MESSAGES[INVALID_SIGN] ="Invalid sign";
        SEMANTIC_ERROR_MESSAGES[INVALID_TYPE] ="Mismatched datatype";
        SEMANTIC_ERROR_MESSAGES[INVALID_VARIABLE] ="Invalid variable";
        SEMANTIC_ERROR_MESSAGES[TYPE_MISMATCH] ="Invalid type";
        SEMANTIC_ERROR_MESSAGES[TYPE_MUST_BE_INTEGER] ="Datatype must be integer";
        SEMANTIC_ERROR_MESSAGES[TYPE_MUST_BE_NUMERIC] ="Datatype must be integer or real";
        SEMANTIC_ERROR_MESSAGES[TYPE_MUST_BE_BOOLEAN] ="Datatype must be boolean";
        SEMANTIC_ERROR_MESSAGES[INCOMPATIBLE_ASSIGNMENT] ="Incompatible assignment";
        SEMANTIC_ERROR_MESSAGES[INCOMPATIBLE_COMPARISON] ="Incompatible comparison";
        SEMANTIC_ERROR_MESSAGES[DUPLICATE_CASE_CONSTANT] ="Duplicate CASE constant";
        SEMANTIC_ERROR_MESSAGES[INVALID_CONTROL_VARIABLE] ="Invalid control variable datatype";
        SEMANTIC_ERROR_MESSAGES[NAME_MUST_BE_PROCEDURE] ="Must be a procedure name";
        SEMANTIC_ERROR_MESSAGES[NAME_MUST_BE_FUNCTION] = "Must be a function name";
        SEMANTIC_ERROR_MESSAGES[ARGUMENT_COUNT_MISMATCH] = "Invalid number of arguments";
        SEMANTIC_ERROR_MESSAGES[ARGUMENT_MUST_BE_VARIABLE] = "Argument must be a variable";
        SEMANTIC_ERROR_MESSAGES[INVALID_REFERENCE_PARAMETER] = "Reference parameter cannot be scalar";
        SEMANTIC_ERROR_MESSAGES[INVALID_RETURN_TYPE] = "Invalid function return type";
        SEMANTIC_ERROR_MESSAGES[TOO_MANY_SUBSCRIPTS] = "Too many subscripts";
        SEMANTIC_ERROR_MESSAGES[INVALID_FIELD] = "Invalid field";
    }
    ...
    void flag(Error error, int lineNumber, string text) {
        ...
        printf("%03d  %-40s \"%s\"\n", lineNumber, SEMANTIC_ERROR_MESSAGES[error].c_str(), text.c_str());
    }
